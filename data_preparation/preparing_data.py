...
def prepare_all_data(csv_data_path: str, ecu_names: list, include_port_switch: list, config_path: str) -> DataFrame:
    ...
    with open("data_tesxt.txt",'w') as outfile:
...
if __name__ == '__main__':
    ...
    logger = set_logger()
    data = prepare_all_data(csv_data_path=r"C:\Users\LENOVO\Desktop\Data\IPB_data.csv", ecu_names=['ICON'], include_port_switch=[True], config_path=r"C:\Users\LENOVO\Documents\GitHub\dash-cytoscape\demos\data\config.json")
    print(data)
...
if __name__ == '__main__':
    ...
    logger = set_logger()
    data = prepare_all_data(csv_data_path=r"C:\Users\LENOVO\Desktop\Data\IPB_data.csv", ecu_names=['IDCevo'], include_port_switch=[True], config_path=r"C:\Users\LENOVO\Documents\GitHub\dash-cytoscape\demos\data\config.json")
    print(data)
